<template>
  <div class="container-fluid">
    ...
    <div style="font-weight:bold;padding: 1rem">
      ...
      <span
        v-show="showClear"
        class="flt-btn fake-link"
        style="font-weight: 500;padding: 0 1rem"
        @click="flt_reset()"
      >
        {{lng.filtersReset}}
        <i class="fa fa-times" />
    ...
    <div class="thumbnail flt-grp">
      <div class="flt-btn fake-link" @click="expand($event.currentTarget)">
        {{lng.price}}
        <i
          class="fa fa-angle-up font1 pull-right"
          style="display:none"
          aria-hidden="true"
        />
